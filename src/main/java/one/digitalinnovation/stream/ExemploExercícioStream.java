...
public class ExemploExercícioStream {

    public static void main(String[] args) {

        //Cria a a coleção de estudantes
        Lisdt<String> estudantes = new ArrayList<>();
        ...
        System.out.println("Retorna os elementos: " + estudantes.stream().pesek(System.out::println).collect(Collectors.toList()));
